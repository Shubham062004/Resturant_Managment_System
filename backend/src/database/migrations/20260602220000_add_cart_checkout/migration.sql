...
-- CreateEnum
CREATE TYPE "OrderDraftStatus" AS ENUM ('PENDING', 'PAYMENT_FAILED', 'COMPLETED');
...
CREATE TABLE "OrderDraft" (
    ...
    "status" "OrderDraftStatus" NOT NULL DEFAULT 'PENDING',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Payment_orderDraftId_key" ON "Payment"("orderDraftId");
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_orderDraftId_fkey" FOREIGN KEY ("orderDraftId") REFERENCES "OrderDraft"("id") ON DELETE CASCADE ON UPDATE CASCADE;
