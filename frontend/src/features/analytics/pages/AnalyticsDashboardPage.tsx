...
import { fetchExecutiveSummary, fetchSalesTrends, fetchCustomerAnalytics, fetchProductAnalytics, fetchDeliveryAnalytics } from '../store/analyticsSlice';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-primary/10 border-primary/20">
              <CardContent className="p-6">
                ...
                <h3 className="text-3xl font-bold text-white">${executive?.revenueToday?.toFixed(2) || '0.00'}</h3>
              </CardContent>
            </Card>
            <Card className="bg-blue-500/10 border-blue-500/20">
              <CardContent className="p-6">
                <p className="text-blue-500 font-medium mb-1">Orders Today</p>
                <h3 className="text-3xl font-bold text-white">{executive?.totalOrdersToday || 0}</h3>
              </CardContent>
            </Card>
            <Card className="bg-green-500/10 border-green-500/20">
              <CardContent className="p-6">
                <p className="text-green-500 font-medium mb-1">Active Staff</p>
                <h3 className="text-3xl font-bold text-white">{executive?.activeStaffCount || 0}</h3>
              </CardContent>
            </Card>
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-10">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-display font-bold text-white mb-2">Analytics & Business Intelligence</h1>
          <p className="text-muted-foreground">Comprehensive reporting and data visualization engine.</p>
        </div>
      </div>
