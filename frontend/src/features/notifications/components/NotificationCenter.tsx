...
export default function NotificationCenter() {
  ...
  return (
    <div className="relative">
      <button onClick={toggleDropdown} className="relative p-2 rounded-full hover:bg-slate-700 transition">
              ...
              list.map((notif: any) => (
                ...
                >
                  <div className="flex justify-between mb-1">
                    ...
                    {notif.status !== 'READ' && <span className="w-2 h-2 bg-blue-500 rounded-full"></span>}
                  </div>
