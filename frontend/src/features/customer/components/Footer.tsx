    ...
    <footer className="bg-card border-t border-border/80 pt-16 pb-8 text-muted-foreground select-none">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          <Link to="/" className="flex items-center gap-2.5 font-display font-extrabold text-xl tracking-tight text-white">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground/80">
            Enterprise restaurant systems serving premium fire-baked pizza catalogs, gourmet burgers, and quick counter orders.
          </p>
        ...
        <div className="space-y-4">
          <h3 className="text-white font-display font-bold text-sm tracking-wide">Popular Choices</h3>
          <ul className="space-y-2 text-sm">
            <li><Link to="/search?category=pizza" className="hover:text-primary transition-colors">Firebrick Pizzas</Link></li>
            <li><Link to="/search?category=burgers" className="hover:text-primary transition-colors">Craft Burgers</Link></li>
            <li><Link to="/search?category=chinese" className="hover:text-primary transition-colors">Chinese Bistro</Link></li>
            <li><Link to="/search?category=desserts" className="hover:text-primary transition-colors">Gourmet Desserts</Link></li>
            <li><Link to="/search?category=drinks" className="hover:text-primary transition-colors">Cold Drinks</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/branches" className="hover:text-primary transition-colors">Outposts & Branches</Link></li>
            <li><Link to="/offers" className="hover:text-primary transition-colors">Promotion Coupons</Link></li>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs leading-relaxed text-muted-foreground/80">
            Subscribe to receive details on featured restaurant recipes, weekly discounts, and outpost schedules.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-border/40 mt-12 pt-8 flex flex-col sm:flex-row justify-between text-xs text-muted-foreground/60 font-sans gap-4">
        ...
        <div className="flex gap-6">
          ...
          <a href="#" className="hover:underline">POS API Clearances</a>
        </div>
      </div>
    </footer>
  );
