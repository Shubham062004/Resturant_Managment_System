...
export const ContactPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast.success('Your message has been received! Our support dispatch will respond within 4 hours.');
      setName('');
      setEmail('');
      setMessage('');
    }, 800);
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 md:py-16 space-y-12">
        ...
        <div className="text-center space-y-3">
          <h1 className="text-3xl md:text-4xl font-display font-extrabold tracking-tight text-white">Contact Dispatch</h1>
          <p className="text-muted-foreground text-sm font-sans max-w-md mx-auto">
            Encountering trouble at a dispatch outpost or have a custom catering inquiry? Drop our desk a line.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-t border-border/40 pt-12">
          ...
          <div className="md:col-span-5 space-y-6">
            <h2 className="text-lg font-display font-bold text-white tracking-wide">Support Channels</h2>
            ...
            <div className="space-y-4">
              <div className="flex gap-4 p-4 rounded-xl bg-card/45 border border-border/50">
                ...
                <div className="space-y-1 font-sans text-xs">
                  ...
                  <p className="text-[10px] text-muted-foreground/60">Mon-Sun: 8:00 AM - 11:00 PM EST</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-4 rounded-xl bg-card/45 border border-border/50">
                ...
                <div className="space-y-1 font-sans text-xs">
                  ...
                  <p className="text-[10px] text-muted-foreground/60">Corporate/API requests: ops@ovenxpress.com</p>
                </div>
              </div>
